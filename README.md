# sample-static-dotnet

**One repo: static frontend + ASP.NET Core API.**
...
op build-push
docker run -p 8081:8080 sample-static-dotnet-api
docker run -p 8080:8080 -e PORT=8080 sample-static-dotnet-frontend
```
